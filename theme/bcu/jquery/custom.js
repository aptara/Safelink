jQuery(document).ready(function($) {
   ...
   /* $( ".breadcrumb li:not(:last-child) span").not('.divider').addClass('spnlink').append( '<span class="arrow-top"></span><span class="arrow-bottom"></span>' );
    ...
    $(".breadcrumb li:first-child a").empty().append( "<i class='fa fa-home'></i>" );
	
	$( ".breadcrumb li span a span[itemprop='title']").removeClass('spnlink');
	*/
	 $(".breadcrumb li:first-child a").empty().append( "<i class='fa fa-home'></i>" );
	$( ".breadcrumb li:not(:last-child) span").not('.divider').each(function( index ) {
	 $(this).addClass('spnlink').append( '<span class="arrow-top"></span><span class="arrow-bottom"></span>' );
	});
	$(".breadcrumb li:last-child").addClass("lastli");
	
	$( ".breadcrumb li span a span[itemprop='title']").each(function( index ) {
	 $(this).removeClass('spnlink');
	});
	
	$( ".breadcrumb li span a span[itemprop='title'] span.arrow-top").each(function( index ) {
	 $(this).remove();
	});
	
	$( ".breadcrumb li span a span[itemprop='title'] span.arrow-bottom").each(function( index ) {
	 $(this).remove();
	});
