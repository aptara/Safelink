...
function scorm_print_launch ($user, $scorm, $action, $cm) {
	...
	$ScormGrade = scorm_grade_user($scorm, $user->id);
    ...
    if ($scorm->lastattemptlock == 0 || $result->attemptleft > 0 ) {
        ...
        echo html_writer::end_div();
			...
			echo html_writer::start_div('scorm-center scorm-completed');
			echo html_writer::label('You have already completed the module/scorm activity', 'n');
			echo html_writer::end_div();
