...
class block_iomad_reports extends block_base {
    ...
    public function get_content() {
        ...
        foreach ($reports as $report) {
		   ...
		   $this->content->text .= '<a class=\"testlink\" href="'.$CFG->wwwroot.'/userreports/participants_list.php" ><div class="iomadlinkreports">
											<div class="iomadicon">'.$icon.'
                                           <div class="actiondescription"> Participants List</div></div></div>
                                    </a>';
		   $this->content->text .= '<a class=\"testlink\" href="'.$CFG->wwwroot.'/userreports/grader_log.php" ><div class="iomadlinkreports">
											<div class="iomadicon">'.$icon.'
                                           <div class="actiondescription">Grader Log</div></div></div>
                                    </a>';
		  $this->content->text .= '<a class=\"testlink\" href="'.$CFG->wwwroot.'/userreports/live_log.php" ><div class="iomadlinkreports">
											<div class="iomadicon">'.$icon.'
                                           <div class="actiondescription">Live Log</div></div></div>
                                    </a>';
									
		  $this->content->text .= '<a class=\"testlink\" href="'.$CFG->wwwroot.'/userreports/participant_log.php" ><div class="iomadlinkreports">
											<div class="iomadicon">'.$icon.'
                                           <div class="actiondescription"> Participant  Log</div></div></div>
                                    </a>';
            $this->content->text .= '<a class=\"testlink\" href="'.$CFG->wwwroot.'/userreports/course_activity_log.php" ><div class="iomadlinkreports">
											<div class="iomadicon">'.$icon.'
                                           <div class="actiondescription">Course Activity Log</div></div></div>
                                    </a>';
			$this->content->text .= '<a class=\"testlink\" href="'.$CFG->wwwroot.'/userreports/download_certificates.php" ><div class="iomadlinkreports">
											<div class="iomadicon">'.$icon.'
                                           <div class="actiondescription">Download Certificates</div></div></div>
                                    </a>';
